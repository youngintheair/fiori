		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Exercise 12 Use Data Types and Input Validation",
									"targetURL": "#synce18exercise12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18exercise12-display": {
								"semanticObject": "synce18exercise12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.exercise12",
									"url": sap.ui.require.toUrl("sync/e18/exercise12")
								}
							}
						}
					}
