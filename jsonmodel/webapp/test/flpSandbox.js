		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#synce18jsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18jsonmodel-display": {
								"semanticObject": "synce18jsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.jsonmodel",
									"url": sap.ui.require.toUrl("sync/e18/jsonmodel")
								}
							}
						}
					}
