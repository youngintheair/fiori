		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce18exercise10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18exercise10-display": {
								"semanticObject": "synce18exercise10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.exercise10",
									"url": sap.ui.require.toUrl("sync/e18/exercise10")
								}
							}
						}
					}
