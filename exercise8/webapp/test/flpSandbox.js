		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce18exercise8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18exercise8-display": {
								"semanticObject": "synce18exercise8",
								"action": "display",
								"description": "UX400",
								"title": "Create and Use Fragments",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.exercise8",
									"url": sap.ui.require.toUrl("sync/e18/exercise8")
								}
							}
						}
					}
