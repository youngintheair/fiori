		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce18excercise11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18excercise11-display": {
								"semanticObject": "synce18excercise11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.excercise11",
									"url": sap.ui.require.toUrl("sync/e18/excercise11")
								}
							}
						}
					}
