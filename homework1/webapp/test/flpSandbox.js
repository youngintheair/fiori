		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "항공편 정보 ",
									"targetURL": "#synce18homework1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18homework1-display": {
								"semanticObject": "synce18homework1",
								"action": "display",
								"description": "UI5 과제 1 - E18",
								"title": "항공편 정보 ",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.homework1",
									"url": sap.ui.require.toUrl("sync/e18/homework1")
								}
							}
						}
					}
