		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Exercise 13. Binding에서 다양하게 사용해보기",
									"targetURL": "#synce18exercise13-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce18exercise13-display": {
								"semanticObject": "synce18exercise13",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e18.exercise13",
									"url": sap.ui.require.toUrl("sync/e18/exercise13")
								}
							}
						}
					}
